...
namespace Penguin.Persistence.Abstractions
{
    ...
    public abstract class PersistenceContext<T> : IPersistenceContext<T> where T : KeyedObject
    {
        ...
        IQueryable<T> IPersistenceContext<T>.All => throw new NotImplementedException();
        ...
        void IPersistenceContext.Add(object o) => this.Add((T)o);
        ...
        void IPersistenceContext.AddOrUpdate(object o) => this.AddOrUpdate((T)o);
        ...
        void IPersistenceContext.AddOrUpdateRange(IEnumerable o) => this.AddOrUpdateRange(o.Cast<T>());
        ...
        void IPersistenceContext.AddRange(IEnumerable o) => this.AddRange(o.Cast<T>());
        ...
        void IPersistenceContext.Delete(object o) => this.Delete((T)o);
        ...
        void IPersistenceContext.DeleteRange(IEnumerable o) => this.DeleteRange(o.Cast<T>());
        ...
        IEnumerable IPersistenceContext.FindRange(IEnumerable Key) => this.FindRange(Key);
        ...
        void IPersistenceContext.Update(object o) => this.Update((T)o);
        ...
        void IPersistenceContext.UpdateRange(IEnumerable o) => this.UpdateRange(o.Cast<T>());
